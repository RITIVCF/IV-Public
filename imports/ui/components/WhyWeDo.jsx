  ...
  render() {
    return (
      <section className="WhyWeDo">
        ...
        <section>
          <h2>Large Group</h2>
          <p>The whole chapter gathers for worship and to discuss about topics relevant
          ...
          for a great night of fellowship!</p>
        </section>
        ...
        <section>
          ...
          in growing together.</p>
        </section>
        <div className="band Prayer"><span></span></div>
        <section>
          <h2>Prayer</h2>
          <p>Do you like talking with your best friend? We do, too. That's why we
          ...
          and us better together.</p>
        </section>
        <div className="band Conferences"><span></span></div>
        <section>
          <h2>Conferences</h2>
          <p>This is a bunch of text describing why we do what we do!</p>
        </section>
